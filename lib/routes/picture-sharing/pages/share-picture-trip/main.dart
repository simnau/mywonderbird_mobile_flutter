...
class SharePictureTripScreen extends StatefulWidget {
  SharePictureTripScreen();

  @override
  _SharePictureTripScreenState createState() => _SharePictureTripScreenState();
}

class _SharePictureTripScreenState extends State<SharePictureTripScreen> {
